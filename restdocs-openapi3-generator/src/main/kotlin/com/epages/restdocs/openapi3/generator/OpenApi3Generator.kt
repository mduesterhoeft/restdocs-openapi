package com.epages.restdocs.openapi3.generator
...
object OpenApi3Generator {
    ...
    fun generate(
        ...
        return OpenAPI().apply {
            ...
            apiUrls.forEach { addServersItem(Server().apply { url = it }) }
            info = Info().apply {
                this.title = title
    ...
    private fun extractDefinitions(openApi: OpenAPI): OpenAPI {
